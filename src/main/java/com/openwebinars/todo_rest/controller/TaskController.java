package com.openwebinars.todo_rest.controller;

import java.util.List;

import com.openwebinars.todo_rest.dto.EditTaskCommand;
import com.openwebinars.todo_rest.dto.GetTaskDto;
...
import com.openwebinars.todo_rest.service.TaskService;
...
public class TaskController {
	...
	@PostMapping
	public ResponseEntity<GetTaskDto> create(@RequestBody EditTaskCommand cmd, @AuthenticationPrincipal User author){
